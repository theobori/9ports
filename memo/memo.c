...
// Port comment
//
// Defined via the compiler via mk
#ifndef FACE_DIR
	#define FACE_DIR "/lib/face"
#endif

// Port comment
//
// Allow dynamic face paths
char *facepaths[] = {
	/* logos */
	FACE_DIR "/48x48x4/g/glenda.1",
	FACE_DIR "/48x48x2/p/pjw+9ball.2",

	/* /sys/doc/9.ms authors */
	FACE_DIR "/48x48x2/k/ken.1",
	FACE_DIR "/48x48x4/b/bobf.1",
	FACE_DIR "/48x48x4/p/philw.1",
	FACE_DIR "/48x48x4/p/presotto.1",
	FACE_DIR "/48x48x4/r/rob.1",
	FACE_DIR "/48x48x4/s/sean.1",

	/* additional authors and luminaries for harder levels */
	FACE_DIR "/48x48x4/b/bwk.1",
	FACE_DIR "/48x48x4/c/cyoung.1",
	FACE_DIR "/48x48x4/d/dmr.1",
	FACE_DIR "/48x48x4/d/doug.1",
	FACE_DIR "/48x48x4/h/howard.1",
	FACE_DIR "/48x48x4/j/jmk.1",
	FACE_DIR "/48x48x4/s/sape.1",
	FACE_DIR "/48x48x4/s/seanq.1",
	FACE_DIR "/48x48x4/t/td.1",
	FACE_DIR "/48x48x8/l/lucent.1",
};
