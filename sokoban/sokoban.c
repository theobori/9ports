...
Image *img = NULL;		/* buffer */
Image *text = NULL;		/* for text messages */
Image *win = NULL;

Image *goal = NULL;
Image *cargo = NULL;
Image *goalcargo = NULL;
Image *wall = NULL;
Image *empty = NULL;
Image *gleft = NULL;
Image *gright = NULL;
...
Menu lmenu =
{
	// Port comment
	//
	// Removed compiler error, it's initialized in the buildmenu function anyway
	// levelnames,
};
...
key2move(int key)
{
	...
	// Port comment
	//
	// For some reason the down arrow has the numeric value 128 for me,
	// I keep the old value to not break anything
	case 63488:
	case 128:
		k = Down;
		break;
