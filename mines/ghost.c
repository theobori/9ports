...
// Port comment
//
// Anonymous union struct was not working even with the GCC -fms-extensions flag.
// QLock and Rendez fields are now as explicit as possible.
// The whole file code has been updated to works with this change.
struct Ghost {
	QLock QLock;
	Rendez Rendez;
	int active, wait;
