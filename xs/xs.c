...
// Port comment
//
// Needed for the sysconf function
#include <unistd.h>
...
setparms(void)
{
	// Port comment
	//
	// /dev/hz is specific to Plan 9 and not UNIX compliant
	// char buf[32];
	// int fd, n;
...
threadmain(int argc, char *argv[])
{
	...
	// Port comment
	//
	// Comment useless variable since we dont want the scores being written
	// int i, scores;
	int i;
	...
	// Port comment
	//
	// Comment this lines to avoid the score being written
